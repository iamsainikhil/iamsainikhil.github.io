...
export class BlogPostComponent implements OnInit, OnDestroy {
  ...
  getBlogPostData(id) {
    this.subscription = this.commonService
      .getDocumentData("blogs", id, { timestamp: true })
      .subscribe(() => {
        this.postData = this.commonService.getDocumentData("blogs", id, {
          timestamp: true
        });
  ...
  getBlogPostSCDData(id) {
    const subscription = this.commonService
      .getSubCollectionDocumentData("blogs", id, "content", "post")
      .subscribe(() => {
        this.postSubCollectionDocumentData = this.commonService.getSubCollectionDocumentData(
          "blogs",
          id,
          "content",
          "post"
